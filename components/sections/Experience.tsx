  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5 md:gap-2 min-h-[300px] md:h-[44vh]">
        <div className="bg-[#161616] p-6 md:p-10 flex flex-col justify-between min-h-[220px]">
          <p className="eyebrow !text-[#DEDBC8] mb-3">The experience</p>
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-1.5 md:gap-2">
        {pillars.map((pillar, i) => (
          <Reveal key={pillar.eyebrow} delay={0.08 * i}>
            <div className="bg-[#212121] p-5 md:p-7 h-full">
              <h3 className="font-heading text-[#DEDBC8] text-lg md:text-2xl font-bold mb-3">
                {pillar.eyebrow}
              </h3>
              <ul className="space-y-2" role="list">
                {pillar.items.map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <span className="font-assistant text-[#E1E0CC]/80 text-sm md:text-base leading-snug">
                      {item}
                    </span>
                  </li>
                ))}
